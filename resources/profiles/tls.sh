    ...
    --ipset-exclude={ipset-exclude}
        --out-range=-d10
            --payload=tls_client_hello
                ...
                --lua-desync=luaexec:code=desync.ovl=resolve_pos(desync.reasm_data,desync.l7payload,"midsld-1")
                ...
                --lua-desync=tcpseg:pos=midsld,-1:tcp_ts_up:ip_id=seq:ip_id_conn
                --lua-desync=drop