									...
									<div class="${ style.settingsRowActions }">
										<Select
											...
											:options="[
												...
												{ name: 'XBox DNS — 111.88.96.51', ip: '111.88.96.51' },
												{ name: 'Malw.link — 95.216.204.218', ip: '95.216.204.218' },
												{ name: 'Malw.link — 80.253.249.40', ip: '80.253.249.40' },
												{ name: 'Mafioznik — 103.27.157.38', ip: '103.27.157.38' },
												{ name: 'Mafioznik — 103.27.157.100', ip: '103.27.157.100' },
												{ name: 'GeoHide — 45.155.204.190', ip: '45.155.204.190' },
												{ name: 'GeoHide — 37.230.192.51', ip: '37.230.192.51' },
												{ name: 'GeoHide — 95.182.120.241', ip: '95.182.120.241' },
											...
											<FloatLabel variant="in">
												<Select
													...
													:options="[
														...
														{ name: 'Astracat — dns.astracat.ru', url: 'https://dns.astracat.ru/dns-query' },
														{ name: 'XBox DNS — xbox-dns.ru', url: 'https://xbox-dns.ru/dns-query' },
														{ name: 'Malw.link — dns.malw.link', url: 'https://dns.malw.link/dns-query' },
														{ name: 'Malw.link — 5u35p8m9i7.cloudflare-gateway.com', url: 'https://5u35p8m9i7.cloudflare-gateway.com/dns-query' },
														{ name: 'Mafioznik — dns.mafioznik.xyz', url: 'https://dns.mafioznik.xyz/dns-query' },
														{ name: 'GeoHide — geohide.ru', url: 'https://geohide.ru/dns-query' },
